...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.128-kirby-problem-4.128-50a1737f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.128"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.128-kirby-problem-4.128-50a1737f-v1",
      "problem_contract_sha256": "4c8ccba40660e4d72159e346ff437e9bd71cac963523603758c54ff0bcac1fea",
      "problem_id": "problem:um-kp-4.128-kirby-problem-4.128-50a1737f",
      "route_id": "route:um-kp-4.128-kirby-problem-4.128-50a1737f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.128-kirby-problem-4.128-50a1737f-source-fidelity-01",
      "graph_id": "graph:um-kp-4.128-kirby-problem-4.128-50a1737f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.128-kirby-problem-4.128-50a1737f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.128-kirby-problem-4.128-50a1737f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the structure of 4-manifolds that admit a Riemannian metric of positive scalar curvature? There are variations of this problem for different classes of manifolds. (a) Is every closed simply connected PSC 4-manifold diffeomorphic to a connected sum of copies of $\\mathbb{CP}^{2}, \\mathbb{CP}^{2}$, and $S^{2} \\times S^{2}$? (b) What is the structure of non-simply connected closed PSC 4-manifolds? (c) Which 4-manifolds with boundary have a PSC metric? (d) Which non-compact 4-manifolds have a complete PSC metric with uniformly positive scalar curvature?"
          },
          "statement_sha256": "365ccc19682aa460a257ac503586e03fa40d298e54037aace1cb43555563392f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.128-kirby-problem-4.128-50a1737f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.128-kirby-problem-4.128-50a1737f-root",
      "route_id": "route:um-kp-4.128-kirby-problem-4.128-50a1737f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.128-2975cd3ef703",
        "url": "https://www.unsolvedmath.com/problems/KP-4.128"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
